...
export async function jobs() {
    ...
    try {
        ...
        console.log('Executing load data Sellout Periodo Enero 2022')
        const dataSellout_01 = await sequelize.query(
            `select * from axeso.fn_cargar_sellout_por_periodo_actual('461','01')`,
            { type: Sequelize.QueryTypes.SELECT }
        );
        console.log('Done Job Sellout Periodo Enero 2022', dataSellout_01)

        console.log('Executing load data Sellout Periodo Febrero 2022')
        const dataSellout_02 = await sequelize.query(
            `select * from axeso.fn_cargar_sellout_por_periodo_actual('462','02')`,
            { type: Sequelize.QueryTypes.SELECT }
        );
        console.log('Done Job Sellout Periodo Febrero 2022', dataSellout_02)
        
        console.log('Executing load data Sellout Periodo Marzo 2022')
        const dataSellout_03 = await sequelize.query(
            `select * from axeso.fn_cargar_sellout_por_periodo_actual('463','03')`,
            { type: Sequelize.QueryTypes.SELECT }
        );
        console.log('Done Job Sellout Periodo Marzo 2022', dataSellout_03)
        
        console.log('Executing load data Sellout Periodo Abril 2022')
        const dataSellout_04 = await sequelize.query(
            `select * from axeso.fn_cargar_sellout_por_periodo_actual('464','04')`,
            { type: Sequelize.QueryTypes.SELECT }
        );
        console.log('Done Job Sellout Periodo Abril 2022', dataSellout_04)
        
        console.log('Executing load data Sellout Periodo Mayo 2022')
        const dataSellout_05 = await sequelize.query(
            `select * from axeso.fn_cargar_sellout_por_periodo_actual('465','05')`,
            { type: Sequelize.QueryTypes.SELECT }
        );
        console.log('Done Job Sellout Periodo Mayo 2022', dataSellout_05)
        
        console.log('Executing load data Sellout Periodo Junio 2022')
        const dataSellout_06 = await sequelize.query(
            `select * from axeso.fn_cargar_sellout_por_periodo_actual('466','06')`,
            { type: Sequelize.QueryTypes.SELECT }
        );
        console.log('Done Job Sellout Periodo Junio 2022', dataSellout_06)
        
        console.log('Executing load data Sellout Periodo Julio 2022')
        const dataSellout_07 = await sequelize.query(
            `select * from axeso.fn_cargar_sellout_por_periodo_actual('467','07')`,
            { type: Sequelize.QueryTypes.SELECT }
        );
        console.log('Done Job Sellout Periodo Julio 2022', dataSellout_07)
